...
const translations = {
  ...
  fontSongti: { zh: '宋体', en: 'Songti' },
  fontKaiti: { zh: '楷体', en: 'Kaiti' },
  theme: { zh: '界面风格', en: 'Theme' },
  themeLight: { zh: '浅色', en: 'Light' },
  themeDark: { zh: '深色', en: 'Dark' },
  themeSystem: { zh: '跟随系统', en: 'System' },
  data: { zh: '数据', en: 'Data' },
  exportData: { zh: '导出 PDF', en: 'Export PDF' },
  exportDataDesc: { zh: '生成精美排版的 PDF 日记册', en: 'Generate a beautifully formatted PDF journal' },
