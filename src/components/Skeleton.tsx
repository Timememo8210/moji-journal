    ...
    <div className="rounded-2xl border border-gray-100 overflow-hidden animate-pulse">
      ...
      <div className="p-5 space-y-3">
        ...
        <div className="space-y-2">
          ...
          <div className="h-3.5 bg-gray-50 rounded-full w-3/4" />
        </div>
      </div>
    </div>
  )
...
export function SkeletonList() {
  return (
    <div className="space-y-6">
      <div className="h-3 bg-gray-100 rounded-full w-20 mb-6" />
...
export function SkeletonDetail() {
  return (
    <div className="animate-pulse max-w-journal mx-auto px-6 py-8">
      <div className="h-3 bg-gray-100 rounded-full w-40 mb-4" />
      <div className="h-7 bg-gray-100 rounded-full w-64 mb-8" />
